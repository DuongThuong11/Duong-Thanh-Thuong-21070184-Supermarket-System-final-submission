...
class PlacementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create placement" do
    assert_difference("Placement.count") do
      post placements_url, params: { placement: { area: @placement.area, floor: @placement.floor, row: @placement.row } }
    end
  ...
  test "should update placement" do
    patch placement_url(@placement), params: { placement: { area: @placement.area, floor: @placement.floor, row: @placement.row } }
